...
export interface OverallPieceDataLCL {
  id: string;
  packageType: string;
  description: string;
  weight: number;
...
interface OverallPieceAccordionLCLProps {
  piece: OverallPieceDataLCL;
  index: number;
  isOpen: boolean;
  onToggle: () => void;
  onRemove: () => void;
...
export const OverallPieceAccordionLCL: React.FC<
  OverallPieceAccordionLCLProps
> = ({
  piece,
  index,
  isOpen,
